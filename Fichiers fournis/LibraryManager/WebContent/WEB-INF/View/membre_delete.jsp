...
<body>
  ...
  <main>
    <section class="content">
      ...
      <div class="row">
      <div class="container">
      <h5>Suppression du membre n°<c:out value="${membre.id}"/></h5>
        <div class="row">
          <p>Êtes-vous sûr de vouloir supprimer la fiche de <c:out value="${membre.nom}"/> <c:out value="${membre.prenom}"/> ?</p> 
